...
int32_t CModel::CountPOFModelItems(
    void *modelDataP,
...
CFace *CModel::AddPOFFace(
    ...
    for (i = nVerts, pVertexIndex = WORDPTR(p + 30); i; i--, pVertexIndex++, uvl++, pVertex++, vertexNormalP++) {
        ...
        pVertex->m_renderColor = pVertex->m_baseColor = baseColor;
...
int32_t CModel::GetPOFModelItems(
    void *modelDataP,
