...
tUVL rodUvlList[4] = {{0x0200, 0x0200, 0}, {0xfe00, 0x0200, 0}, {0xfe00, 0xfe00, 0}, {0x0200, 0xfe00, 0}};
...
// returns 1 if off screen, 0 if drew
int32_t G3DrawRodTexPoly(
    CBitmap *pBm,
    CRenderPoint *btmPoint,
    fix xBtmWidth,
    CRenderPoint *topPoint,
    fix xTopWidth,
    fix light,
    tUVL *uvlList,
    int32_t bAdditive) {
    ...
    if (!uvlList)
        uvlList = rodUvlList;
    uvlList[0].l = uvlList[1].l = uvlList[2].l = uvlList[3].l = light;
