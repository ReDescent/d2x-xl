...
CFixVector *COmegaLightning::GetGunPoint(CObject *pObj, CFixVector *vMuzzle) {
    ...
    if ((bSpectate || (pObj->info.nId != N_LOCALPLAYER)) && (vGunPoints = GetGunPoints(pObj, 6))) {
...
void COmegaLightning::Init(void) {
    ...
    omegaLightningInfo[0]
        .color.Set((uint8_t)(255 * 0.9f), (uint8_t)(255 * 0.6f), (uint8_t)(255 * 0.6f), (uint8_t)(255 * 0.3f));
    omegaLightningInfo[1]
        .color.Set((uint8_t)(255 * 0.9f), (uint8_t)(255 * 0.6f), (uint8_t)(255 * 0.6f), (uint8_t)(255 * 0.3f));
};
