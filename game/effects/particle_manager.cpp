...
void CParticleManager::Init(void) {
    ...
    CFloatMatrix mat;
    mat.m.dir.r.v.coord.z = mat.m.dir.u.v.coord.z = mat.m.dir.f.v.coord.x = mat.m.dir.f.v.coord.y = 0;
    mat.m.dir.f.v.coord.z = 1;
    CFloatVector dir;
    dir.Set(1.0f, 1.0f, 0.0f, 1.0f);
    for (int32_t i = 0; i < PARTICLE_POSITIONS; i++) {
        mat.m.dir.r.v.coord.x = mat.m.dir.u.v.coord.y = sinCosPart[i].fCos;
...
int32_t CParticleManager::Create(
    CFixVector *vPos,
    CFixVector *vDir,
    CFixMatrix *mOrient,
    int16_t nSegment,
...
int32_t CParticleManager::EndRender(void) { return 1; }

//------------------------------------------------------------------------------

CParticleManager::~CParticleManager() { Shutdown(); }
