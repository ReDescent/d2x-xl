...
CWeaponInfo defaultWeaponInfoD2[] = {
    {2,
     ...
     65536,
     196608,
     {589824, 589824, 589824, 589824, 589824},
    ...
    {2,
     ...
     72089,
     196608,
     {638976, 638976, 638976, 638976, 589824},
    ...
    {2,
     ...
     75366,
     196608,
     {688128, 688128, 688128, 688128, 655360},
    ...
    {2,
     ...
     78643,
     196608,
     {737280, 737280, 737280, 737280, 720896},
    ...
    {1,
     ...
     131072,
     163840,
     {65536, 262144, 393216, 524288, 655360},
     {5242880, 5570560, 5898240, 6553600, 7208960},
     13107,
     0,
     0,
     655360,
    ...
    {2,
     ...
     327680,
     458752,
     {655360, 983040, 1310720, 1638400, 1966080},
    ...
    {2,
     ...
     327680,
     458752,
     {524288, 786432, 1179648, 1507328, 1966080},
    ...
    {2,
     ...
     196608,
     196608,
     {65536, 131072, 196608, 262144, 393216},
     {1966080, 2621440, 3276800, 3932160, 5242880},
     6553,
     0,
     0,
    ...
    {2,
     ...
     196608,
     {131072, 196608, 196608, 262144, 393216},
     {2490368, 3145728, 3801088, 4456448, 5111808},
     6553,
     0,
     0,
     642252,
    ...
    {3,
     ...
     131072,
     229376,
     {196608, 327680, 458752, 524288, 655360},
    ...
    {2,
     ...
     327680,
     1966080,
     {3276800, 4587520, 5898240, 7208960, 7864320},
     {4259840, 4915200, 5570560, 5570560, 5570560},
     65536,
     0,
     0,
     655360,
    ...
    {3,
     ...
     458752,
     {262144, 393216, 589824, 720896, 851968},
     {2621440, 3276800, 3932160, 4587520, 5898240},
     65536,
     0,
     0,
     65536,
    ...
    {2,
     ...
     81920,
     196608,
     {819200, 819200, 819200, 819200, 786432},
     {8847360, 8847360, 8847360, 8847360, 8847360},
     39321,
     0,
     0,
    ...
    {-1,
     ...
     229376,
     {1638400, 1638400, 1638400, 1638400, 1638400},
     {45875200, 45875200, 45875200, 45875200, 45875200},
     13107,
     0,
     0,
     655360,
    ...
    {3,
     ...
     229376,
     {786432, 786432, 786432, 786432, 786432},
     {9175040, 9175040, 9175040, 9175040, 9175040},
     655,
     0,
     0,
     655360,
    ...
    {3,
     ...
     81920,
     262144,
     {458752, 458752, 458752, 458752, 458752},
     {65536000, 65536000, 65536000, 65536000, 65536000},
     655,
     0,
     0,
     655360,
    ...
    {2,
     ...
     458752,
     {589824, 589824, 589824, 589824, 589824},
     {7208960, 7208960, 7208960, 7208960, 7208960},
     65536,
     0,
     0,
     655360,
    ...
    {2,
     ...
     327680,
     458752,
     {3604480, 3604480, 3604480, 3604480, 3604480},
    ...
    {2,
     ...
     327680,
     327680,
     {3276800, 3276800, 3276800, 3276800, 3276800},
     {26214400, 26214400, 26214400, 26214400, 26214400},
     78643,
     0,
     0,
     655360,
    ...
    {2,
     ...
     327680,
     3276800,
     {14417920, 14417920, 14417920, 14417920, 14417920},
     {7864320, 7864320, 7864320, 7864320, 7864320},
     65536,
     0,
     0,
    ...
    {2,
     ...
     131072,
     163840,
     {65536, 65536, 131072, 131072, 196608},
     {4587520, 5898240, 7864320, 9830400, 11141120},
     655,
     0,
     0,
     642252,
    ...
    {3,
     ...
     131072,
     {131072, 196608, 262144, 327680, 393216},
     {983040, 1638400, 2949120, 3932160, 5242880},
     6553,
     0,
     0,
     642252,
    ...
    {2,
     ...
     91750,
     196608,
     {196608, 262144, 327680, 458752, 524288},
     {1638400, 2293760, 3604480, 5242880, 5898240},
     6553,
     0,
     0,
     642252,
    ...
    {3,
     ...
     131072,
     229376,
     {262144, 327680, 393216, 524288, 589824},
     {2293760, 2949120, 4259840, 5242880, 5898240},
     655,
     0,
     0,
     655360,
    ...
    {3,
     ...
     131072,
     229376,
     {327680, 458752, 589824, 720896, 786432},
     {4587520, 5898240, 7208960, 9175040, 10485760},
     655,
     0,
     0,
     655360,
    ...
    {3,
     ...
     131072,
     163840,
     {196608, 327680, 458752, 589824, 720896},
     {4259840, 5242880, 6553600, 7208960, 7864320},
     13107,
     0,
     0,
     655360,
    ...
    {3,
     ...
     131072,
     229376,
     {196608, 327680, 458752, 524288, 589824},
     {3276800, 5242880, 6553600, 7864320, 9830400},
     655,
     0,
     0,
     655360,
    ...
    {3,
     ...
     {2293760, 3604480, 4259840, 4915200, 5242880},
     65536,
     0,
     0,
     65536,
    ...
    {2,
     ...
     327680,
     458752,
     {131072, 262144, 393216, 458752, 524288},
     {2293760, 3604480, 4259840, 5570560, 6225920},
     65536,
     0,
     0,
     655360,
    ...
    {-1,
     ...
     131072,
     229376,
     {393216, 524288, 655360, 851968, 983040},
     {6553600, 16384000, 26214400, 26214400, 26214400},
     13107,
     0,
     0,
     655360,
    ...
    {3,
     ...
     327680,
     458752,
     {327680, 655360, 983040, 1310720, 1966080},
     {0, 0, 0, 0, 0},
     65536,
     2162,
     0,
    ...
    {2,
     ...
     327680,
     1966080,
     {6553600, 6553600, 6553600, 6553600, 6553600},
     {18677760, 18677760, 18677760, 18677760, 18677760},
     65536,
     0,
     0,
     655360,
    ...
    {2,
     ...
     327680,
     655360,
     {983040, 1310720, 1638400, 1966080, 2293760},
     {3276800, 4587520, 6553600, 9830400, 13107200},
     78643,
     0,
     0,
     655360,
    ...
    {2,
     ...
     327680,
     458752,
     {589824, 851968, 1179648, 1507328, 1966080},
     {2949120, 3932160, 5242880, 5898240, 6225920},
     65536,
     0,
     0,
     65536,
    ...
    {2,
     ...
     327680,
     3276800,
     {3932160, 4587520, 5570560, 6553600, 7208960},
     {3276800, 4587520, 5898240, 7208960, 7864320},
     65536,
     0,
     0,
    ...
    {2,
     ...
     327680,
     1966080,
     {589824, 983040, 1310720, 1769472, 1966080},
     {2621440, 3932160, 5242880, 6553600, 7864320},
     65536,
     0,
     0,
     655360,
    ...
    {3,
     ...
     81920,
     262144,
     {327680, 458752, 655360, 786432, 917504},
     {6553600, 9830400, 11141120, 12451840, 13762560},
     655,
     0,
     0,
     655360,
    ...
    {2,
     ...
     327680,
     458752,
     {458752, 589824, 655360, 720896, 786432},
     {3604480, 4915200, 5570560, 6225920, 6881280},
     65536,
     0,
     0,
     655360,
...
void QSortTextureIndex(int16_t *pti, int16_t left, int16_t right) {
    int16_t l = left, r = right, m = pti[(left + right) / 2], h;
...
void BuildTextureIndex(int32_t i, int32_t n) {
    int16_t *pti =
        gameData.pigData.tex.textureIndex[i].Buffer(); // translates global texture ids to level (geometry) texture ids
...
void BMReadAll(CFile &cf, bool bDefault) {
    ...
    gameData.weaponData.info[0][48].light =
        I2X(1); // fix light for BPer shots and smart missile blobs - don't make them too bright though
    ...
    if (bDefault) {
        ...
        memcpy(
            gameData.modelData.polyModels[1].Buffer(),
            gameData.modelData.polyModels[0].Buffer(),
            gameData.modelData.nPolyModels * sizeof(CPolyModel));
    }
    PrintLog(-1);
    ...
    if (gameData.pigData.tex.nHamFileVersion < 3) {
        ...
        gameData.endLevelData.exit.nModel = gameData.endLevelData.exit.nDestroyedModel = gameData.modelData.nPolyModels;
}
...
void BMReadGameDataD1(CFile &cf) {
    ...
    for (i = 0, pr = &gameData.botData.info[1][0]; i < D1_MAX_ROBOT_TYPES; i++, pr++) {
        ...
        cf.Seek(
            sizeof(int32_t) * 3 + (sizeof(CFixVector) + sizeof(uint8_t)) * MAX_GUNS + sizeof(int16_t) * 5 +
                sizeof(int8_t) * 7 + sizeof(fix) * 4 + sizeof(fix) * 7 * DIFFICULTY_LEVEL_COUNT +
        ...
        cf.Seek(JOINTLIST_SIZE * (MAX_GUNS + 1) * N_ANIM_STATES + sizeof(int32_t), SEEK_CUR);
    ...
    cf.Seek(
        h + sizeof(tBitmapIndex) * D1_MAX_GAUGE_BMS + sizeof(int32_t) * 2 * D1_MAX_POLYGON_MODELS +
            sizeof(tBitmapIndex) * D1_MAX_OBJ_BITMAPS + sizeof(uint16_t) * D1_MAX_OBJ_BITMAPS + PLAYER_SHIP_SIZE +
            sizeof(int32_t) + sizeof(tBitmapIndex) * D1_N_COCKPIT_BITMAPS,
        SEEK_CUR);
    PrintLog(-1);
