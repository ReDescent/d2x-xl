...
class CSimplex {
    ...
    static double Noise2(
        double x,
        double y,
        double *dx = 0,
        double *dy = 0); // The analytic derivative is for flow animations, curl noise, analytic antialiasing etc.
    static double Noise3(double x, double y, double z, double *dx = 0, double *dy = 0, double *dz = 0);
    static double
    Noise4(double x, double y, double z, double w, double *dx = 0, double *dy = 0, double *dz = 0, double *dw = 0);
};
