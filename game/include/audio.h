...
class CAudio {
    ...
    int32_t StartSound(
        int16_t nSound,
        int32_t nSoundClass = SOUNDCLASS_GENERIC,
        fix nVolume = DEFAULT_VOLUME,
        int32_t nPan = DEFAULT_PAN,
        int32_t bLooping = 0,
        int32_t nLoopStart = -1,
        int32_t nLoopEnd = -1,
        int32_t nSoundObj = -1,
        int32_t nSpeed = I2X(1),
        const char *pszWAV = NULL,
        CFixVector *vPos = NULL);
    ...
    int32_t CreateObjectSound(
        int16_t nSound,
        int32_t nSoundClass,
        int16_t nObject,
        int32_t bForever = 0,
        fix maxVolume = I2X(1),
        fix maxDistance = I2X(256),
        int32_t nLoopStart = -1,
        int32_t nLoopEnd = -1,
