...
// Actually using some MTU as packet size for TCP isn't necessary as TCP will properly packetize outgoing data depending
// on the actual local MTU. Some meaningful packet size should be used anyway though, and using a common MTU here
// shouldn't be the worst idea.

#define DL_HEADER_SIZE 5
#define DL_PACKET_SIZE \
    PPPoE_MTU // 1024 + 256 + 128 + DL_HEADER_SIZE; data transfer will be unstable at larger sizes for me (?)
