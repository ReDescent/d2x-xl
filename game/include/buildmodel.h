...
static inline int IsDefaultModel(int nModel) {
    return (nModel >= gameData.modelData.nPolyModels) ||
           (gameData.modelData.polyModels[1][nModel].Buffer() && (gameData.modelData.polyModels[0][nModel].DataSize() ==
                                                                  gameData.modelData.polyModels[1][nModel].DataSize()));
}
