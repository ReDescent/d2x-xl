...
class CRGBColor {
    ...
    inline void Set(uint8_t red, uint8_t green, uint8_t blue) { r = red, g = green, b = blue; }
...
template <uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha> class CStaticFaceColor : public CFaceColor {
    public:
...
template <uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha> class CStaticCanvasColor : public CCanvasColor {
    public:
