...
#define SB_ENERGY_GAUGE_H \
    ((gameStates.video.nDisplayMode ? 60 : 29) + (gameStates.app.bD1Mission ? SB_AFTERBURNER_GAUGE_H : 0))
...
#define SB_SHIELD_NUM_Y \
    (SB_SHIELD_GAUGE_Y - (gameStates.video.nDisplayMode ? 16 : 8)) // 156 -- MWA used to be hard coded to 156
...
#define SB_SECONDARY_W_BOX_LEFT \
    (gameStates.video.nDisplayMode ? SB_SECONDARY_W_BOX_LEFT_H : SB_SECONDARY_W_BOX_LEFT_L) // 210
#define SB_SECONDARY_W_BOX_TOP (gameStates.video.nDisplayMode ? SB_SECONDARY_W_BOX_TOP_H : SB_SECONDARY_W_BOX_TOP_L)
#define SB_SECONDARY_W_BOX_RIGHT \
    (gameStates.video.nDisplayMode ? SB_SECONDARY_W_BOX_RIGHT_H : SB_SECONDARY_W_BOX_RIGHT_L)
...
#define SB_PRIMARY_AMMO_X \
    (SB_PRIMARY_W_BOX_LEFT + \
     (gameStates.video.nDisplayMode ? (38 + 20) : 30)) // ((SB_PRIMARY_W_BOX_LEFT+33)-3)	// (51+32)
