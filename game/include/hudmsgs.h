...
#ifdef __GNUC__
void HUDMessage(int32_t msgClass, const char *format, ...) __attribute__((format(printf, 2, 3)));
int32_t _CDECL_ HUDInitMessage(const char *format, ...) __attribute__((format(printf, 1, 2)));
void _CDECL_ HUDPlayerMessage(const char *format, ...) __attribute__((format(printf, 1, 2)));
#else
