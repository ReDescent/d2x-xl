...
static inline void ShortSwap(int16_t *s) { *s = SWAPSHORT(*s); }

//------------------------------------------------------------------------------

static inline void UShortSwap(uint16_t *s) { *s = SWAPUSHORT(*s); }

//------------------------------------------------------------------------------

static inline void FixSwap(fix *f) { *f = (fix)SWAPINT((int32_t)*f); }
...
static inline void FixAngSwap(fixang *f) { *f = (fixang)SWAPSHORT((int16_t)*f); }
