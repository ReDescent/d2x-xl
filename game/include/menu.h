...
class CMenuItem {
    ...
    int32_t GetSize(
        int32_t h,
        int32_t aw,
        int32_t &nStringWidth,
        int32_t &nStringHeight,
    ...
    inline int32_t &Value(void) { return m_value; }
    ...
    inline int32_t &MinValue(void) { return m_minValue; }
    inline int32_t &MaxValue(void) { return m_maxValue; }
    inline int32_t Range(void) { return MaxValue() - MinValue() + 1; }
    inline void Redraw(void) { m_bRedraw = 1; }
    inline void Rebuild(void) { m_bRebuild = 1; }
    inline int32_t Rebuilding(void) { return m_bRebuild; }
    inline char *Text(void) { return m_text; }
    inline int32_t ToInt(void) { return atol(m_text); }
...
typedef struct tMenuProps {
    int32_t screenWidth, screenHeight, x, y, xOffs, yOffs, userWidth, userHeight, width, height, aw, titleWidth,
        titleHeight, ty, titlePos, rightOffset, nStringHeight, bTinyMode, nMenus, nOthers, nMaxNoScroll, nMaxOnMenu,
        nMaxDisplayable, nScrollOffset, bIsScrollBox, nDisplayMode, bValid;
...
class CMenu : public CStack<CMenuItem> {
    ...
    inline CMenuItem &operator[](const int32_t i) { return CStack<CMenuItem>::operator[](i); }
    ...
    int32_t AddInput(
        ...
        const char *szHelp = NULL);
    int32_t
    AddInputBox(const char *szId, const char *szText, int32_t nLen, int32_t nKey = 0, const char *szHelp = NULL);
    ...
    void SetBoxColor(uint8_t red = PAL2RGBA(22), uint8_t green = PAL2RGBA(22), uint8_t blue = PAL2RGBA(38)) {
        Background().SetBoxColor(red, green, blue);
    }
    ...
    int32_t Menu(
        ...
        int32_t *nCurItemP = NULL,
        int32_t nType = BG_SUBMENU,
        int32_t nWallpaper = BG_STANDARD,
        int32_t width = -1,
        int32_t height = -1,
        int32_t bTinyMode = 0);
    ...
    int32_t
    Setup(int32_t nType, int32_t width, int32_t height, int32_t bTinyMode, pMenuCallback callback, int32_t &nItem);
    void Update(
        const char *pszTitle,
        const char *pszSubTitle,
        int32_t nType,
...
typedef int32_t (*pListBoxCallback)(int32_t *nItem, CArray<char *> &items, int32_t *keypress);
...
class CListBox : public CMenu {
    ...
    int32_t ListBox(
        const char *pszTitle,
        CStack<char *> &items,
        int32_t nDefaultItem = 0,
        int32_t bAllowAbort = 1,
