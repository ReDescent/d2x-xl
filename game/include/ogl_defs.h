...
#define OglVertexPointer(size, type, stride, pointer) \
    ogl.VertexPointer(size, type, stride, pointer, const_cast<char *>(__FILE__), __LINE__)
#define OglColorPointer(size, type, stride, pointer) \
    ogl.ColorPointer(size, type, stride, pointer, const_cast<char *>(__FILE__), __LINE__)
#define OglTexCoordPointer(size, type, stride, pointer) \
    ogl.TexCoordPointer(size, type, stride, pointer, const_cast<char *>(__FILE__), __LINE__)
#define OglNormalPointer(type, stride, pointer) \
    ogl.NormalPointer(type, stride, pointer, const_cast<char *>(__FILE__), __LINE__)
#else
