...
// Additionally, several constants which apply to homing gameData.objData.objects in general control the behavior of
//the Omega Cannon. 	They are defined in fireweapon.h.  They are copied here for reference.  These values are valid on
//1/10/96: 	If you want the Omega Cannon view cone to be different than the Homing Missile viewcone, contact MK to make
//the change. 	 (Unless you are a programmer, in which case, do it yourself!)
