...
#define VISITED(_nSegment, _nThread) \
    (gameData.renderData.mine.visibility[_nThread].bVisited[_nSegment] == \
     gameData.renderData.mine.visibility[_nThread].nVisited)
#define VISIT(_nSegment, _nThread) \
    (gameData.renderData.mine.visibility[_nThread].bVisited[_nSegment] = \
         gameData.renderData.mine.visibility[_nThread].nVisited)
