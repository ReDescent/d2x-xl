...
class CSphereEdge : public CMeshEdge {
    ...
    inline bool operator==(CSphereEdge &other) {
        return ((CFloatVector::Dist(m_vertices[0][0], other.m_vertices[0][0]) < 1e-6f) &&
                (CFloatVector::Dist(m_vertices[1][0], other.m_vertices[1][0]) < 1e-6f)) ||
               ((CFloatVector::Dist(m_vertices[0][0], other.m_vertices[1][0]) < 1e-6f) &&
                (CFloatVector::Dist(m_vertices[1][0], other.m_vertices[0][0]) < 1e-6f));
    }
...
class CTesselatedSphere : public CSphere {
    ...
    virtual int32_t HasQuality(int32_t nDesiredQuality) {
        return m_nQuality == Max(SPHERE_MIN_QUALITY, nDesiredQuality);
    }
    virtual int32_t FaceNodes(void) = 0;
