...
class CTransformation {
    ...
    _INLINE_ CFixVector &Translate(CFixVector &dest, const CFixVector &src) { return dest = src - m_info.pos; }
    ...
    inline int32_t HaveHeadAngles(void) {
        return m_info.bUsePlayerHeadAngles && (m_info.playerHeadAngles.Mag() > 0.05f);
    }
};
