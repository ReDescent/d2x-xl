...
extern UI_GADGET_BUTTON *ui_add_gadget_button(
    UI_WINDOW *wnd,
    int16_t x,
    int16_t y,
    int16_t w,
...
extern UI_GADGET_LISTBOX *ui_add_gadget_listbox(
    UI_WINDOW *wnd,
    int16_t x,
    int16_t y,
    int16_t w,
...
extern UI_GADGET_SCROLLBAR *ui_add_gadget_scrollbar(
    UI_WINDOW *wnd,
    int16_t x,
    int16_t y,
    int16_t w,
...
extern UI_GADGET_RADIO *
ui_add_gadget_radio(UI_WINDOW *wnd, int16_t x, int16_t y, int16_t w, int16_t h, int16_t group, char *text);
extern void ui_radio_do(UI_GADGET_RADIO *radio, int32_t keypress);

extern void ui_draw_checkbox(UI_GADGET_CHECKBOX *checkbox);
extern UI_GADGET_CHECKBOX *
ui_add_gadget_checkbox(UI_WINDOW *wnd, int16_t x, int16_t y, int16_t w, int16_t h, int16_t group, char *text);
...
extern void
ui_listbox_change(UI_WINDOW *wnd, UI_GADGET_LISTBOX *listbox, int16_t numitems, char *list, int32_t text_width);

extern void ui_draw_inputbox(UI_GADGET_INPUTBOX *inputbox);
extern UI_GADGET_INPUTBOX *
ui_add_gadget_inputbox(UI_WINDOW *wnd, int16_t x, int16_t y, int16_t w, int16_t h, char *text);
...
UI_GADGET_ICON *ui_add_gadget_icon(
    UI_WINDOW *wnd,
    char *text,
    int16_t x,
    int16_t y,
