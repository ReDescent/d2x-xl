...
void MouseConfigCallback(int nitems, tMenuItem *items, int *key, int nCurItem) {
    int h, i, v;
    ...
    do {
        do {
            ...
            if (gameOpts->input.mouse.bUse || gameStates.app.bNostalgia) {
                ...
                mouseOpts.nSensitivity = AddAxisControls(
                    m,
                    &szMouseSens[0][0],
                    TXT_MOUSE_SENS,
                    TXT_MOUSE_SENS_N,
                    ...
                    KEY_O,
                    axis3DHotkeys,
                    gameOpts->input.mouse.bSyncAxes,
                    &opt);
                if (gameOpts->input.mouse.bUse && !gameStates.app.bNostalgia) {
                    ADD_TEXT(opt, "", 0);
                    opt++;
                    ...
                    if (gameOpts->input.mouse.bJoystick && gameOpts->app.bExpertMode)
                        mouseOpts.nDeadzone = AddDeadzoneControl(
                            m,
                            szMouseDeadzone,
                            TXT_MOUSE_DEADZONE,
                            HTX_MOUSE_DEADZONE,
...
void JoystickConfigCallback(int nitems, tMenuItem *items, int *key, int nCurItem) {
    int h, i, v;
    int ocType = gameConfig.nControlType;
    tMenuItem *m;
    ...
    do {
        do {
            ...
            if (gameOpts->input.joystick.bUse || gameStates.app.bNostalgia) {
                ...
                h = gameOpts->input.joystick.bSyncAxes ? 1 : UNIQUE_JOY_AXES;
                joyOpts.nSensitivity = AddAxisControls(
                    m,
                    &szJoySens[0][0],
                    TXT_JOY_SENS,
                    TXT_JOY_SENS_N,
                    ...
                    KEY_S,
                    joyHotkeys,
                    gameOpts->input.joystick.bSyncAxes,
                    &opt);
                if (!gameStates.app.bNostalgia) {
                    joyOpts.nDeadzone = AddAxisControls(
                        m,
                        &szJoyDeadzone[0][0],
                        TXT_JOY_DEADZONE,
                        TXT_JOY_DEADZONE_N,
...
void TrackIRConfigCallback(int nitems, tMenuItem *items, int *key, int nCurItem) {
    int h, i, v;
    tMenuItem *m;
    ...
    do {
        ...
        if (gameOpts->input.trackIR.bUse) {
            ...
            if ((gameOpts->input.trackIR.nMode != 1) || gameOpts->input.trackIR.bMove[0] ||
                ...
                tirOpts.nSensitivity = AddAxisControls(
                    m,
                    &szTrackIRSens[0][0],
                    TXT_TRACKIR_SENS,
                    TXT_TRACKIR_SENS_N,
                    ...
                    KEY_S,
                    axis3DHotkeys,
                    gameOpts->input.trackIR.bSyncAxes,
                    &opt);
                tirOpts.nDeadzone = AddDeadzoneControl(
                    m,
                    szTrackIRDeadzone,
                ...
                tirOpts.nSyncAxes = tirOpts.nDeadzone = -1;
        }
...
void KeyboardConfigCallback(int nitems, tMenuItem *items, int *key, int nCurItem) {
    int i, v;
    tMenuItem *m;
