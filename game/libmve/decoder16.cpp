    ...
    for (j = 0; j < yb; j++) {
        for (i = 0; i < xb / 2; i++) {
            ...
            /*
              ...
              (*pMap) & 0xf); else if (FramePtr >= backBuf1 + g_width*g_height) fprintf(stderr, "danger!  pointing out
              of bounds above after dispatch decoder: %d, %d (1) [%x]\n", i, j, (*pMap) & 0xf);
            */
            ...
            /*
              ...
              (*pMap) >> 4); else if (FramePtr >= backBuf1 + g_width*g_height) fprintf(stderr, "danger!  pointing out of
              bounds above after dispatch decoder: %d, %d (2) [%x]\n", i, j, (*pMap) >> 4);
            */
...
static void patternRow4Pixels(uint16_t *pFrame, uint8_t pat0, uint8_t pat1, uint16_t *p) {
...
static void patternRow4Pixels2(uint16_t *pFrame, uint8_t pat0, uint16_t *p) {
    uint8_t mask = 0x03;
    uint8_t shift = 0;
    uint16_t pel;
...
static void patternRow4Pixels2x1(uint16_t *pFrame, uint8_t pat, uint16_t *p) {
    uint8_t mask = 0x03;
    uint8_t shift = 0;
    uint16_t pel;
...
static void
patternQuadrant4Pixels(uint16_t *pFrame, uint8_t pat0, uint8_t pat1, uint8_t pat2, uint8_t pat3, uint16_t *p) {
    uint32_t mask = 3;
    int32_t shift = 0;
    int32_t i;
...
static void patternRow2Pixels(uint16_t *pFrame, uint8_t pat, uint16_t *p) {
    uint8_t mask = 0x01;
...
static void patternRow2Pixels2(uint16_t *pFrame, uint8_t pat, uint16_t *p) {
    uint16_t pel;
    uint8_t mask = 0x1;
...
static void patternQuadrant2Pixels(uint16_t *pFrame, uint8_t pat0, uint8_t pat1, uint16_t *p) {
