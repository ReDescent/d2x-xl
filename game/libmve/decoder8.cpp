...
static void
patternQuadrant4Pixels(uint8_t *pFrame, uint8_t pat0, uint8_t pat1, uint8_t pat2, uint8_t pat3, uint8_t *p) {
    uint32_t mask = 3;
    int32_t shift = 0;
    int32_t i;
...
static void dispatchDecoder(
    ...
    */
    ...
    case 0x0:
        ...
        copyFrame(
            pFrame,
            pFrame + (reinterpret_cast<uint8_t *>(g_vBackBuf2) - reinterpret_cast<uint8_t *>(g_vBackBuf1)));
    ...
    case 0x4:
        ...
        */
        ...
        copyFrame(
            pFrame,
            pFrame + (reinterpret_cast<uint8_t *>(g_vBackBuf2) - reinterpret_cast<uint8_t *>(g_vBackBuf1)) + x +
                y * g_width);
        pFrame += 8;
        --*remainDataP;
        break;
