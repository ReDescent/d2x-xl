    {428, 0x008000L}, {429, 0x008000L}, {430, 0x020000L}, {431, 0x020000L}, {432, 0x00e000L}, {433, 0x020000L},
    {434, 0x020000L}};
...
int32_t LightingCacheVisible(
    ...
    if ((cache_frame == 0) || (cache_frame + nLightingFrameDelta <= gameData.appData.nFrameCount)) {
        ...
        lightingCache[((nSegment << LIGHTING_CACHE_SHIFT) ^ nVertex) & (LIGHTING_CACHE_SIZE - 1)] =
            bApplyLight + (gameData.appData.nFrameCount << 1);
        return bApplyLight;
    }
    nCacheHits++;
    return cache_vis;
...
void SetDynColor(
    CFloatVector *color,
    CFloatVector3 *pDynColor,
    int32_t nVertex,
    uint8_t *bGotDynColorP,
    int32_t bForce) {
    if (!color)
        return;
#if 1
    ...
    if (!pDynColor) {
        SetDynColor(
            color,
            &gameData.renderData.lights.globalDynColor,
            0,
            &gameData.renderData.lights.bGotGlobalDynColor,
            bForce);
...
bool SkipPowerup(CObject *pObj) {
    ...
    if (gameStates.render.bPerPixelLighting == 2) {
        ...
        if ((id != POW_EXTRA_LIFE) && (id != POW_ENERGY) && (id != POW_SHIELD_BOOST) && (id != POW_HOARD_ORB) &&
            (id != POW_MONSTERBALL) && (id != POW_INVUL)) {
            return true;
        }
    }
    return false;
...
#endif
                {
                    ...
                    if ((dist >> headlightShift) < abs(obji_64)) {
                        ...
                        if (!headlightShift)
                            ...
                            fix dot, maxDot;
                            int32_t spotSize =
                                gameData.renderData.vertColor.bDarkness ? 2 << (3 - extraGameInfo[1].nSpotSize) : 1;
                            ...
                            if (dot < maxDot)
                                gameData.renderData.lights.dynamicLight[nVertex] += FixDiv(
                                    xOrigIntensity,
                                    FixMul(
                                        HEADLIGHT_SCALE,
    ...
    for (i = 0; i < MUZZLE_QUEUE_MAX; i++) {
        if (gameData.muzzleData.info[i].createTime) {
            ...
            if (time_since_flash < FLASH_LEN_FIXED_SECONDS)
                ApplyLight(
                    (FLASH_LEN_FIXED_SECONDS - time_since_flash) * FLASH_SCALE,
                    gameData.muzzleData.info[i].nSegment,
                    &gameData.muzzleData.info[i].pos,
                    nRenderVertices,
                    renderVertices,
                    -1,
                    NULL);
...
fix ComputeLightIntensity(int32_t nObject, CFloatVector *pColor, char *pbGotColor) {
    ...
    pColor->Red() = pColor->Green() = pColor->Blue() = 1.0;
    *pbGotColor = 0;
    switch (nObjType) {
    case OBJ_PLAYER:
        *pbGotColor = 1;
        if (!gameStates.render.nLightingMethod && HeadlightIsOn(pObj->info.nId)) {
            ...
            PLAYER(pObj->info.nId).secondaryAmmo[PROXMINE_INDEX]) {
    ...
    case OBJ_EXPLOSION:
        if (pObj->info.nId == 0xff)
            return 0;
        if ((pObj->info.renderType == RT_THRUSTER) || (pObj->info.renderType == RT_EXPLBLAST) ||
            (pObj->info.renderType == RT_SHOCKWAVE) || (pObj->info.renderType == RT_SHRAPNELS))
            return 0;
            ...
            if (pObj->info.xLifeLeft < I2X(4))
                return FixMul(
                    FixDiv(pObj->info.xLifeLeft, gameData.effectData.animations[0][pObj->info.nId].xTotalTime),
                    xLight);
            else
                return xLight;
        }
...
void SetDynamicLight(void) {
    ...
    gameData.renderData.vertColor.bDarkness =
        IsMultiGame && gameStates.app.bHaveExtraGameInfo[1] && extraGameInfo[IsMultiGame].bDarkness;
    ...
    if (!gameStates.render.nLightingMethod) {
        ...
        for (iVertex = 0; iVertex < nRenderVertices; iVertex++) {
...
#endif
            {
                ...
                memset(
                    gameData.renderData.lights.dynamicColor + nVertex,
                    0,
                    sizeof(gameData.renderData.lights.dynamicColor[0]));
            }
        }
    }
        ...
        for (iRenderSeg = 0; iRenderSeg < gameData.renderData.mine.visibility[0].nSegments; iRenderSeg++) {
            ...
            if (pll->nFrame == gameData.appData.nFrameCount)
                ApplyLight(
                    ...
                    &pll->vPos,
                    nRenderVertices,
                    gameData.renderData.lights.vertices,
                    -1,
                    &pll->color);
        }
    }
...
void ComputeEngineGlow(CObject *pObj, fix *xEngineGlowValue) {
    ...
    if (pObj->info.movementType == MT_PHYSICS) {
        if ((pObj->info.nType == OBJ_PLAYER) && (pObj->mType.physInfo.flags & PF_USES_THRUST) &&
            (pObj->info.nId == N_LOCALPLAYER)) {
...
void ApplyLightToSegment(CSegment *pSeg, CFixVector *vSegCenter, fix xBrightness, int32_t nCallDepth) {
    ...
    fix xDistToRSeg;
    int32_t i;
    int16_t nSide, nSegment = pSeg->Index();
    ...
    if (i == nChangedSegs) {
        ...
        if (xDistToRSeg <= LIGHT_DISTANCE_THRESHOLD) {
            fix xLightAtPoint =
                (xDistToRSeg > I2X(1)) ? FixDiv(MAGIC_LIGHT_CONSTANT, xDistToRSeg) : MAGIC_LIGHT_CONSTANT;
...
void ChangeSegmentLight(int16_t nSegment, int16_t nSide, int32_t dir) {
    ...
    if (pSeg->IsPassable(nSide, NULL) & WID_VISIBLE_FLAG) {
        ...
        fix xBrightness;
        xBrightness = gameData.pigData.tex.pTexMapInfo[pSide->m_nBaseTex].lighting +
                      gameData.pigData.tex.pTexMapInfo[pSide->m_nOvlTex].lighting;
        xBrightness *= dir;
        nChangedSegs = 0;
        if (xBrightness) {
...
int32_t FindDLIndex(int16_t nSegment, int16_t nSide) {
    ...
    int32_t m, l = 0, r = gameData.renderData.lights.nStatic - 1;
...
void ChangeLight(int16_t nSegment, int16_t nSide, int32_t dir) {
    ...
    if ((!gameStates.render.nLightingMethod || gameStates.app.bNostalgia) &&
        gameData.renderData.lights.deltaIndices.Buffer()) {
        ...
        for (; i < gameData.renderData.lights.nStatic; i++, pDeltaIndex++) {
            ...
            if ((iSeg == nSegment) && (iSide == nSide)) {
                ...
                for (j = pDeltaIndex->count; j; j--, pLightDelta++) {
                    ...
                    pUVL = pSide->m_uvls;
                    pSegLightDelta =
                        gameData.renderData.lights.segDeltas + pLightDelta->nSegment * 6 + pLightDelta->nSide;
...
void CLightDeltaIndex::Read(CFile &cf) {
    if (gameStates.render.bD2XLights) {
        ...
        int16_t i =
            (int16_t)
                cf.ReadByte(); // these two bytes contain the side in the lower 3 and the count in the upper 13 bits
