...
bool CDialHeap::Create(int16_t nNodes) {
    ...
    Destroy();
    m_nNodes = nNodes;
    if (!(m_index.Create(65536, "CDialHeap::m_index") && m_dirtyIndex.Create(65536, "CDialHeap::m_dirtyIndex") &&
          m_cost.Create(nNodes, "CDialHeap::m_cost") && m_dirtyCost.Create(nNodes, "CDialHeap::m_dirtyCost") &&
          m_links.Create(nNodes, "CDialHeap::m_links") && m_pred.Create(nNodes, "CDialHeap::m_pred") &&
