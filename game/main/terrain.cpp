...
//!!#define HEIGHT (_i, _j)   gameData.renderData.terrain.heightmap [(gameData.renderData.terrain.nGridH -
//! 1-j)*gameData.renderData.terrain.nGridW+ (_i)]
//!!#define LIGHT (_i, _j)    gameData.renderData.terrain.lightmap [(gameData.renderData.terrain.nGridH -
//! 1-j)*gameData.renderData.terrain.nGridW+ (_i)]
...
void DrawTerrainCell(int32_t i, int32_t j, CRenderPoint *p0, CRenderPoint *p1, CRenderPoint *p2, CRenderPoint *p3) {
    ...
    gameData.renderData.terrain.uvlList[0][0].u = gameData.renderData.terrain.uvlList[0][1].u = (i) * (I2X(1) / 4);
    gameData.renderData.terrain.uvlList[0][0].v = gameData.renderData.terrain.uvlList[0][2].v = (j) * (I2X(1) / 4);
    ...
    G3DrawTexPoly(
        3,
        pointList,
        gameData.renderData.terrain.uvlList[0],
        gameData.renderData.terrain.pBm,
        NULL,
        1,
        0,
        -1);
    ...
    gameData.renderData.terrain.uvlList[1][1].u = gameData.renderData.terrain.uvlList[1][2].u = (i + 1) * (I2X(1) / 4);
    gameData.renderData.terrain.uvlList[1][0].v = gameData.renderData.terrain.uvlList[1][1].v = (j + 1) * (I2X(1) / 4);
    ...
    G3DrawTexPoly(
        3,
        pointList,
        gameData.renderData.terrain.uvlList[1],
        gameData.renderData.terrain.pBm,
        NULL,
        1,
        0,
...
void RenderTerrain(CFixVector *vOrgPoint, int32_t org_2dx, int32_t org_2dy) {
    ...
    gameData.renderData.terrain.vStartPoint =
        *vOrgPoint - mSurfaceOrient.m.dir.r * ((gameData.renderData.terrain.orgI - iLow) * TERRAIN_GRID_SCALE);
    gameData.renderData.terrain.vStartPoint -=
        mSurfaceOrient.m.dir.f * ((gameData.renderData.terrain.orgJ - jLow) * TERRAIN_GRID_SCALE);
...
void LoadTerrain(char *filename) {
    ...
    PrintLog(
        0,
        "heightmap loaded, size=%dx%d\n",
        gameData.renderData.terrain.nGridW,
        gameData.renderData.terrain.nGridH);
