...
const char *defaultGameTexts[][2] = {
    ...
    {"Keine oder ungueltige IP-Adresse.\nBeitritt abgebrochen",
     "No or invalid IP address specified.\nJoin request cancelled."},
    ...
    {"Redbook-Audio ist per Kommando-\nzeile deaktiviert worden",
     "Redbook audio has been disabled\non the command line"},
    {"Kann CD-Musik nicht starten.  Ein anderes\nProgramm verwendet das CD-Laufwerk.",
     "Cannot start CD Music.\nAnother application is\nusing the CD player.\n"},
    {"Kann CD-Musik nicht starten.  Lege die\nDescent II-CD ein und versuche es nochmal",
     "Cannot start CD Music.  Insert\nyour Descent II CD and try again"},
    ...
    {"Fuer ein Teamspiel solltest Du\nwenigstens 2 Spieler auswaehlen",
     "You should select at least two\nplayers to start a team game"},
    {"%d Tracker gefunden", "%d tracker%s found"},
    {"Aktueller %s-Socket ist Standard %+d (aendern mit PgUp/PgDn)",
     "\tCurrent %s Socket is default %+d (PgUp/PgDn to change)"},
    ...
    {"Diese Shareware-Version erlaubt\nnur die ersten 4 Level!",
     "This SHAREWARE version only supports\nthe first 4 levels!"},
    ...
    {"Fehler beim Speichern des Spiels.\nEvtl. zuwenig Speicherplatz vorhanden.",
    ...
    {"Kann Aussengelaende nicht aus\nDatei %s laden:\nIFF-Fehler: %s",
     "Can't load exit terrain from\nfile %s:\nIFF error: %s"},
    {"Kann Satellit nicht aus\nDatei %s laden:\nIFF-Fehler: %s",
     "Can't load exit satellite from\nfile %s: IFF error: %s"},
    ...
    {"Einseitige Illusion\n(Segment:%d, Seite: %d)!", "Single sided illusion\n(segment:%d, side:%d)!"},
    ...
    {"Rrrrrrreng-deng-deng-badabaaaaambambam-barrrraaaa-darrram-bam-bam!",
     "Rrrrrrreng-deng-deng-badabaaaaambambam-barrrraaaa-darrram-bam-bam!"},
...
const char *defaultHelpTexts[][2] =
    {
        ...
        {"Ankreuzen, wenn Sie ein FCS Flight Control System verwenden.",
         "Check if you are using an FCS Flight Control System."},
        {"Ankreuzen, wenn Sie eine Gravis Flugsteuerung verwenden.",
         "Check if you are using a Gravis flight controller."},
        {"Ankreuzen, um die Kurztasten zur Waffenwahl zu aktivieren.", "Check to active the weapon selection hotkeys."},
        ...
        {"Ankreuzen um die Tastaturbeschleunigung zu aktivieren.", "Check to activate keyboard ramping."},
        ...
        // cockpit options
        {"Groesse der Cockpit-Informationsfenster einstellen.", "Chose a size of the cockpit window views."},
        ...
        {"Menue mit zusaetzlichen Darstellungsoptionen aufrufen.", "Invoke a menu offering additional render options."},
        ...
        {"Ankreuzen, um die Erzeugung von Raucheffekten einzuschalten.", "Check to enable creation of smoke effects."},
        ...
        {"Niemals selbsttaetig die Waffe wechseln.", "Never automatically switch weapons."},
        {"Waffe wechseln, wenn leergeschossen.", "Switch weapon if current weapon is empty."},
        {"Immer die Waffe mit der hoechsten Prioritaet aktivieren.",
         "Always switch to the weapon that has the highest priority."},
        {"Zielfernrohr abschalten.", "Disable weapon zoom."},
        ...
        // options menu
        {"Konfigurationsmenue fuer Klangeffekte und Musik aufrufen.", "Invoke the sound and music configuration menu."},
        {"Konfigurationsmenue fuer Eingabegeraete aufrufen.", "Invoke the game controls configuration menu."},
        {"Joystick-Kalibrierung starten.", "Invoke the joystick calibration."},
        {"Konfiguration der Spieldetaillierung aufrufen.", "Invoke the detail levels menu."},
        {"Auswahlmenue der Bildaufloesung aufrufen.", "Invoke the screen resolution selection menu."},
        ...
        {"Konfigurationsmenue fuer die Pilotenkanzel aufrufen.", "Invoke the cockpit configuration menu."},
        {"Konfigurationsmenue fuer die grafische Darstellung aufrufen.", "Invoke the render options menu."},
        {"Konfigurationsmenue fuer die Spieleinstellungen aufrufen.", "Invoke the gameplay options menu."},
        // get ip address
        ...
        {"Die maximale Anzahl Spielteilnehmer festlegen.", "Adjust the maximum number of game participants here."},
        {"Menue mit weiteren Mehrspielereinstellungen aufrufen.",
         "Invoke a menu offering more multiplayer game settings."},
        {"Menue der Entropieeinstellungen aufrufen.", "Invoke the Entropy settings menu."},
        ...
        {"Menue der Monsterballeinstellungen aufrufen.", "Invoke the Monsterball settings menu."},
        ...
        {"Wenn angekreuzt erzeugen herumfliegende Truemmer eine\nRauchspur.",
         "If checked, debris from robots creates a smoke trail."},
        ...
        {"Wenn angekreuzt werden Schatten fuer Roboter erzeugt.", "If checked, shadows are created for robots."},
        {"Wenn angekreuzt werden Schatten fuer Raketen erzeugt.", "If checked, shadows are created for missiles."},
        {"Wenn angekreuzt werden Schatten fuer Reaktoren erzeugt.", "If checked, shadows are created for reactors."},
        ...
        {"Wenn angekreuzt werden um Lichtquellen herum Lichthoefe gezeichnet.",
         "If checked, coronas are rendered around around light sources."},
        {"Wenn angekreuzt wird die Uebersichtskarte voll texturiert angezeigt.",
         "If checked, the automap is displayed fully textured."},
        {"Hier koennen Einstellungen der Uebersichtskarte vorgenommen werden.",
         "Adjust automap rendering settings here."},
        {"Ankreuzen, damit die texturierte Uebersichtskarte so hell wie\nmoeglich dargestellt wird.",
         "Check to have the textured automap rendered as bright as possible."},
        {"Wenn angekreuzt werden in der texturierten Uebersichtskarte\nauch Lichthoefe gezeichnet.",
         "If checked, light coronas will be rendered in the textured automap."},
        ...
        {"Ankreuzen, damit in der texturierten Uebersichtskarte Rauch-\neffekte dargestellt werden.",
         "Check to have smoke effects rendered in the textured automap."},
        {"Abhaengig von der hier vorgenommenen Einstellungen verbleiben\nExplosionstruemmer laenger und treiben herum.",
         "Depending on the setting made here, debris from explosions\nwill stay longer and keep floating around."},
        {"Wenn angekreuzt werden potentielle Ziele von zielsuchenden Raketen\nmit Dreiecken markiert.",
         "If checked potential targets of homing missiles will be marked\nwith triangles."},
        {"Wenn angekreuzt rotiert die Zielsuch-Anzeige langsam um\ndas Ziel.",
         "If checked the missile target indicator will rotate slowly around\nthe target."},
        {"Wenn angekreuzt erhalten Energieschuesse und Truemmer Lichthoefe.",
         "If checked, debris and shot from energy weapons are rendered with\ncoronas."},
        {"Wenn angekreuzt wird die Umgebung der Mine ('Skybox') in der Ueber-\nsichtskarte gezeichnet.",
         "If checked, the mine's environment ('skybox') is rendered in the\nautomap."},
        {"Hier kann die maximale Zeitlupen-Beschleunigung eingestellt werden.",
         "Adjust the maximal slow motion speedup here."},
        ...
        {"Hier koennen diverse Einstellungen der Spielphysik geaendert werden.",
         "Here you can adjust various settings of the game's physics."},
        ...
        {"Ankreuzen, um das Schiff mit NaturalPoint TrackIR Hardware\nzu steuern.",
         "Check to control the ship with NaturalPoint\nTrackIR hardware."},
        {"Hier kann eingestellt werden, wie empfindlich das Schiff auf\nKopfbewegungen reagiert.",
         "Adjust how sensitive the ship is towards head\nmovements here."},
        {"Hier kann eingestellt werden, wie gross der Bereich ist,\ninnerhalb dessen das Schiff nicht auf Kopfbewegungen\nreagiert.",
         "Adjust how much the head has to be moved before\nthe ship reacts to it."},
        {"Ankreuzen, wenn das Schiff sich entsprechend Kopfdrehungen drehen soll.",
         "Check if the ship should turn according to the head turning."},
        {"Ankreuzen, wenn das Schiff entsprechend lateraler und vertikaler\nKopfbewegungen gleiten soll.",
         "Check if the ship should react to lateral and\nvertical head movements."},
        {"Ankreuzen, wenn der Schub mit Kopfbewegungen geregelt werden soll.",
         "Check if thrust should be controlled by head\nmovements."},
        ...
        {"Hier koennen einem oder mehreren Joysticks oder Gamepads\nSpielaktionen zugeordnet werden.",
         "Assign game actions to one ore more joysticks and gamepads here."},
        {"Hier koennen einem TrackIR-System von NaturalPoint\nSpielaktionen zugeordnet werden.",
         "Assign game actions to a NaturalPoint TrackIR system here."},
        ...
        {"Je hoeher der eingestellte Wert, desto durchsichtiger ercheint\nRauch.",
         "The higher the setting, the more transparent smoke looks."},
        ...
        {"Hier kann zwischen gezackten und wellenfoermigen Entladungs-\nkanaelen gewaehlt werden.",
         "Here you can choose between jaggy and smooth discharge\npaths of lightings."},
        {"Wenn angekreuzt werden Blitze mit einem Plasmakanal gezeichnet.",
         "If checked lightings are render with a plasma channel."},
        {"Wenn angekreuzt schlagen Blitze aus beschaedigten Objekten.",
         "If checked damaged objects show electric discharges."},
        {"Wenn angekreuzt erzeugen einige Explosionen elektrische\nEntladungen.",
         "If checked some explosions cause electric discharges"},
        ...
        {"Wenn angekreuzt erzeugen einige Roboter statische Entladungen.",
         "If checked some robots create static discharges."},
        ...
        {"Wenn angekreuzt feuert die Omega-Kanone Blitze statt weisser\nKugeln.",
         "If checked, the Omega cannon fires lightning bolts\ninstead of white globes."},
        ...
        {"Wenn angekreuzt werden Hires-Modelle heller dargestellt.\n(Sonst sind sie in dunklen Bereichen eventuell schlecht\nsichtbar.)",
         "If checked, hires models are rendered brighter.\n(Otherwise, they might be hard to see in dark areas.)"},
        {"Ankreuzen, damit in der texturierten Uebersichtskarte Blitz-\neffekte dargestellt werden.",
         "Check to have lightning effects rendered in the textured automap."},
        {"Wenn angekreuzt erhalten energetische Powerups Lichthoefe.",
         "If checked, energetic powerups are rendered with coronas."},
        {"Wenn angekreuzt addieren sich Helligkeit und Farbe von\nLichthoefen und ihrem Hintergrund.",
         "If checked, the brightness and color of coronas and their\nbackground are adding up."},
        {"Wenn angekreuzt addieren sich Helligkeit und Farbe der\nLichthoefe von Objekten und ihrem Hintergrund.",
         "If checked, the brightness and color of object's coronas and\ntheir background are adding up."},
        ...
        {"Wenn angekreuzt erhalten Waffen-Powerups Lichthoefe.",
         "If checked, weapon powerups are rendered with coronas."},
        ...
        {"Hier kann das Erscheinungsbild von Lichthoefen angepasst werden.",
         "The appearance of light coronas can be adjusted here."},
        ...
        {"Wenn angekreuzt duerfen Scheinwerfer benutzt werden,\nandernfalls kann man sie nicht einschalten.",
         "If checked using headlights is allowed, otherwise they cannot be\nactivated."},
        ...
        {"Wenn angekreuzt verbrauchen eingeschaltete Scheinwerfer\n(wie gehabt) Strom. Andernfalls benoetigen sie keine Energie.",
         "If checked turned on headlights drain the ship's power (as usual).\nOtherwise, no energy is consumed by the headlight."},
        ...
        {"Hier kann die maximale Anzahl gleichzeitig abspielbarer\nKlaenge eingestellt werden.",
         "Adjust the maximum number of sounds that can be played\nsimultaneously."},
        {"Hier koennen Programmeinstellungen an die Leistungs-\nfaehigkeit des Rechners angepasst werden.",
         "Here you can adjust program settings to your computers\nperformance."},
        ...
        {"Wenn angekreuzt werden die momentan aktiven Waffen an den Spieler-\nschiffen gezeigt.",
         "If checked the currently equipped weapons are shown\non the player ships."},
        {"Wenn angekreuzt, rieseln beim Feuern von Vulcan- oder Gauss-Kanone\nPatronenhuelsen aus der Waffe.",
         "If checked, bullet casings drop out of\nVulcan and Gauss guns when they're fired."},
        ...
        {"Hier kann die Startgeschwindigkeit von Raketen eingestellt werden.",
         "Adjust the launch speed of missiles here."},
        {"Wenn angekreuzt haben Maschinenkanonen ein verbessertes\nGerausch.",
         "If checked gatling guns use an improved sound."},
        ...
        {"Hier kann die Lieblings-Schiffsfarbe ausgesucht werden\n(nur Einzelspieler).",
         "Chose your favorite ship color here (singleplayer only)."},
        {"Wenn angekreuzt werden unerforschte Minenbereiche\nschwarz/weiss dargestellt",
         "If checked, unexplored mine areas are drawn black and white."},
        {"Wenn angekreuzt, erzeugen auch von Robotern abgefeuerte\nOmega-Kanonen Blitzeffekte.",
         "If checked, omega cannons fired by robots\nwill create lightning effects, too."},
        ...
        {"Multi-Threading fuer die Darstellung von Transparenz verwenden.",
         "Use multi threading for rendering transparency."},
        {"Multi-Threading bei der Berechnung von Effekten nutzen.", "Use multi threading for computing effects."},
        {"Multi-Threading fuer die Darstellung von 3D-Objekten verwenden.",
         "Use multi threading for rendering 3D models."},
        {"In diesem Menue koennen Feineinstellungen fuer das Multi-\nThreading vorgenommen werden.",
         "Fine tune multi threading in this menu."},
        ...
        {"Wenn angekreuzt, drehen Bojen sich langsam um ihre Laengs-\nachse und zeigen in der Bojensicht eine 360-Grad-Ansicht\nihrer Umgebung.",
         "If checked, markers will spin slowly, giving you a 360 degree view\nof their environment in the marker view."},
        ...
        {"Wenn angekreuzt, erzeugen Schuesse aus Maschinenkanonen\nfeine Rauchspuren.",
         "If checked, shots from Gatling guns create fine smoke trails."},
        ...
        {"Wenn angekreuzt werden alle Diebe aus dem aktuellen Level\nentfernt.",
         "If checked, all thief bots are removed when playing a level."},
        {"Je nach Einstellung verfolgen Roboter die Spieler zunehmend\naggressiv.",
         "Depending on the setting, robots pursue players increasingly\naggressive."},
        ...
        {"Wenn angekreuzt steigen im Wasser Blasen auf wo vom Autor\ndes Levels vorgesehen.",
         "If checked air bubbles rise under water where the level\nauthor built it in."},
        {"Wenn angekreuzt, schweben Luftblasen beim Aufsteigen etwas\nhin und her.",
         "If checked air bubbles wiggle left and right while rising."},
        {"Wenn angekreuzt, aendern Luftblasen staendig ihre Form",
         "If checked air bubbles slightly change their shape while\nrising."},
        ...
        {"Wenn angekreuzt, erhalten die Icons aktiver Waffen und\nAusruestung besonders fette Rahmen.",
         "If checked, armed weapons and active equipment\nhave a bold frame."},
        ...
        {"Hier kann eine alternative Farbe fuer aktive HUD-Anzeigen\nausgewaehlt werden.",
         "Chose an alternative color for HUD elements here."},
        {"Wenn angekreuzt werden Mod-Daten verwendet;\nandernfalls werden sie ignoriert.",
         "If checked mod data will be used;\notherwise it will be ignored."},
        {"Wenn angekreuzt werden Schild-Powerups dreidimensional dargestellt.",
         "If check shield powerups will be rendered in 3D."},
        {"Hier kann das Tastaturlayout ausgewaehlt werden.", "Chose your keyboard layout here."},
        {"Hier kann das Aussehen von Energie-Leuchtspuren ausgewaehlt werden.",
         "Chose the appearance of energy shot light\ntrails here."},
        ...
        {"Hier kann die Qualitaet der Schattendarstellung ausgewaehlt werden.",
         "Chose the quality of shadow appearance here."},
        ...
        {"Hier koennen Verwendung und Aufloesung von Kameras\neingestellt werden.",
         "Chose the camera usage and resolution here."},
        ...
        {"Wenn angekreuzt, wird die Umgebungslautstaerke der\nEffektlautstaerke angeglichen.",
         "If checked, ambient sound volume is equalized with\neffect sound volume."},
        {"Hier koennen die maximalen Ladekapazitaeten fuer\nRaketen und Minen eingestellt werden.",
         "Adjust the maximum load capacity for missiles\nand mines here."},
        {"Hier kann eingestellt werden, was in den Hilfsanzeigen\ndes Cockpits sichtbar ist.",
         "You can chose what is displayed in the auxiliary\ncockpit windows here."},
        ...
        {"Hier kann mit entsprechenden 3D-Brillen der\n3D-Effekt verstaerkt werden.",
         "Enhance the 3D effect when using appropriate glasses."},
        {"Hier kann die 3D-Ansicht aufgehellt werden\n(dabei koennen Bilddetails verschwinden).",
         "Increase the 3D view's brightness here\n(this can cause image details to disappear)."},
        {"Wenn angekreuzt, werden rechtes und linkes Bild vertauscht.",
         "If checked, left and right frame are exchanged."},
        ...
        {"Hier kann eingestellt werden, in welcher Entfernung im Raum\ndie Bildschirmoberflaeche liegt.",
         "Chose the distance of the screen surface in 3D space here."},
        ...
        {"Wenn angekreuzt, sind helle Leuchteffekte von einem\nLichtschimmer umgeben",
         "When checked, bright light effects are surrounded by glow."},
        ...
        {"Hier kann die Position des Radars im Cockpit ausgewaehlt werden.",
         "Chose the position of the RADAR in the HUD here."},
        ...
        {"Hier kann eingestellt werden, ob die gestrichelten Kreise um\ndas Radar ein- oder mehrfarbig sind.",
         "Chose monochrome or multi colored dashed circles around the\nRADAR here."},
        {"Wenn angekreuzt, werden Zielmarkierungen von Hindernissen\nverborgen, die sich vor Ihnen befinden.",
         "If checked, target indicators are hidden behind obstacles\nin front of them"},
        ...
        {"Hier kann die Geschwindigkeit von Spielerschiffen, Robotern, Raketen und Schuessen eingestellt werden.",
         "Adjust the speed of player ships, robots, missiles and shots here."},
        {"Hier kann die Breite des Sichtfelds eingestellt werden.", "Adjust the width of your periphal vision here."},
        {"Diese Einstellung fuer 3D-Brillen mit zwei verschieden\nfarbigen Glaesern waehlen.",
         "Chose this setting for 3D glasses with two differently colored glasses."},
        {"Hier kann die Farbkombination der Anaglyphenbrille eingestellt werden.",
         "Chose the color combination of the anaglyph glasses here."},
        {"Hier kann die Empfindlichkeit des Positionssensors eingestellt werden.",
         "Adjust the sensitivity of the head tracking sensor here."},
        {"Hier kann ein Oculus Rift konfiguriert werden.", "Configure an Oculus Rift here."},
        {"Wenn angekreuzt, werden auf dem Oculus Rift auftretende\nFarbabweichungen korrigiert.",
         "When checked, chromatic aberrations (color seams) appearing\non the Oculus Rift are corrected."},
        {"Wenn angekreuzt, wird die Levelmusik in zufaelliger\nReihenfolge abgespielt.",
         "If checked, level music will be played in random sequence."},
        ...
        {"Hier kann eingestellt werden, bei welchen Objekten Beschuss\neinen Energieschild aufleuchten laesst.",
         "Chose which objects will show a bright energy shield when being\nhit here."},
        ...
        {"Mit diesem Regler kann die Ladegeschwindigkeit von Schiffsenergie\nund -schild angepasst werden.",
         "Adjust the speed at which ship energy and shields are recharged\nwith this slider."},
        {"Hier kann die Farbe ausgeruesteter Waffen ausgewaehlt werden.", "Chose the color of equipped weapons here."},
        {"Hier kann der Abstand des Kompakt-HUDs vom Fadenkreuz angepasst werden.",
         "Adjust the distance of the compact HUD from the reticle here."},
        {"Hier kann der Abstand des Kompakt-HUDs vom oberen Bildschirmrand\nangepasst werden.",
         "Adjust the distance of the compact HUD from the\nupper screen border here."},
        {"Wenn angekreuzt, wird das Kompakt-HUD mit zusätzlichen Linien\nversehen, um seine Elemente besser abzusetzen.",
         "If checked, the compact HUD is drawn with additional\nlines to better separate it from the reticle."},
        {"Hier kann ausgewaehlt werden, ob das Spiel realistisch oder wie\nein Cartoon aussieht.",
         "Select whether the game looks realistic or like a\ncartoon here."},
        {"Wenn angekreuzt, haben Waffen aus Descent 1 in Descent 2-Missionen\ndieselbe Schlagkraft wie in Descent 1.",
         "If checked, Descent 1 have the same power in Descent 2 missions\nas they have in Descent 1."},
        {"Wenn eingeschaltet, werden unter Wasser und in Lava Dunst gezeichnet.",
         "If turned on, a blue or orange haze is rendered under water and in lava."},
        {"Hier kann die Menge schnellfliegender kleiner Truemmerstuecke von \nExplosionen eingestellt werden. Achtung: Dieser Effekt ist sehr rechenaufwaendig!",
         "Adjust the amount of fast moving explosion shrapnel here.\nCaveat: This effect can lower the frame rate significantly!"},
        {"Wenn angekreuzt, erzeugen Spielerschiffe Kratzgeraeuschen, sobald\nsie an einer Wand entlang schleifen. ",
         "When checked, player ships create scrape sounds when\nsliding along a wall"},
...
char **InitTexts(char *szTextFile, int32_t bInitHotKeys) {
    ...
    for (i = 0; i < j; i++) {
        pSrc = (i < BASE_TEXT_COUNT)
                   ? const_cast<char *>(baseGameTexts[i][0])
                   : const_cast<char *>(defaultGameTexts[i - BASE_TEXT_COUNT][gameStates.app.bEnglish]);
        if (bDumpTexts == 1) {
            char *pi, *pj, s[10000];
