...
void CockpitOptionsMenu(void) {
	...
	m.AddCheck ("target indicators", TXT_TARGET_INDICATORS, extraGameInfo [0].bTargetIndicators, KEY_T, HTX_CPIT_TGTIND);
        ...
        m.AddSlider(
            "compact hud",
            szSlider,
            gameOpts->render.cockpit.nShipStateLayout,
            0,
            2,
            KEY_M,
        ...
        if (gameOpts->render.cockpit.nShipStateLayout) {
            ...
            m.AddSlider(
                "color scheme",
                szSlider,
                gameOpts->render.cockpit.nColorScheme,
                0,
                2,
                KEY_C,
            ...
            if (gameOpts->render.cockpit.nShipStateLayout == 2) {
                if (gameOpts->app.bExpertMode) {
                    ...
                    m.AddSlider(
                        "hud width",
                        szSlider,
                        gameOpts->render.cockpit.nCompactWidth,
                        0,
                        2,
                        KEY_W,
                    ...
                    m.AddSlider(
                        "hud height",
                        szSlider,
                        gameOpts->render.cockpit.nCompactHeight,
                        0,
                        2,
                        KEY_H,
        ...
        m.AddSlider(
            "cockpit window size",
            szSlider,
            gameOpts->render.cockpit.nWindowSize,
            0,
            3,
            KEY_I,
            HTX_CPIT_WINSIZE);
        ...
        m.AddSlider(
            "cockpit window zoom",
            szSlider,
            gameOpts->render.cockpit.nWindowZoom,
            0,
            3,
            KEY_Z,
            HTX_CPIT_WINZOOM);
        ...
        m.AddSlider(
            "cockpit radar size",
            szSlider,
            gameOpts->render.cockpit.nRadarSize,
            0,
            2,
            KEY_O,
            HTX_CPIT_RADARSIZE);
        ...
        m.AddSlider(
            "cockpit radar range",
            szSlider,
            gameOpts->render.cockpit.nRadarRange,
            0,
            4,
            KEY_R,
            HTX_CPIT_RADARRANGE);
        ...
        m.AddSlider(
            "cockpit radar color",
            szSlider,
            gameOpts->render.cockpit.nRadarColor,
            0,
            2,
            KEY_C,
            HTX_CPIT_RADARCOLOR);
        ...
        m.AddSlider(
            "cockpit radar style",
            szSlider,
            gameOpts->render.cockpit.nRadarStyle,
            0,
            1,
            KEY_S,
            HTX_CPIT_RADARSTYLE);
