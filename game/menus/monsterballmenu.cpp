...
static const char *szWeaponIds[] = {
    "Laser 1",      "Laser 2",      "Laser 3", "Laser 4", "Spreadfire", "Vulcan",  "Plasma",      "Fusion",
    "Superlaser 1", "Superlaser 2", "Helix",   "Gauss",   "Phoenix",    "Omega",   "Flare",       "Concussion",
    "Homing",       "Smart",        "Mega",    "Flash",   "Guided",     "Mercury", "Earthshaker", "Shaker Bomblet"};

static const char *szWeaponTexts[] = {
    "Laser 1: %1.2f",    "Laser 2: %1.2f", "Laser 3: %1.2f",     "Laser 4: %1.2f",       "Spreadfire: %1.2f",
    "Vulcan: %1.2f",     "Plasma: %1.2f",  "Fusion: %1.2f",      "Superlaser 1: %1.2f",  "Superlaser 2: %1.2f",
    "Helix: %1.2f",      "Gauss: %1.2f",   "Phoenix: %1.2f",     "Omega: %1.2f",         "Flare: %1.2f",
    "Concussion: %1.2f", "Homing: %1.2f",  "Smart: %1.2f",       "Mega: %1.2f",          "Flash: %1.2f",
    "Guided: %1.2f",     "Mercury: %1.2f", "Earthshaker: %1.2f", "Shaker Bomblet: %1.2f"};
...
static int32_t optionToWeaponId[] = {
    LASER_ID,   LASER_ID + 1, LASER_ID + 2,  LASER_ID + 3,      SPREADFIRE_ID,  VULCAN_ID,
    PLASMA_ID,  FUSION_ID,    SUPERLASER_ID, SUPERLASER_ID + 1, HELIX_ID,       GAUSS_ID,
    PHOENIX_ID, OMEGA_ID,     FLARE_ID,      CONCUSSION_ID,     HOMINGMSL_ID,   SMARTMSL_ID,
    MEGAMSL_ID, FLASHMSL_ID,  GUIDEDMSL_ID,  MERCURYMSL_ID,     EARTHSHAKER_ID, EARTHSHAKER_MEGA_ID};
