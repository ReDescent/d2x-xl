...
// char *NetworkModeNames[]={"Anarchy", "Team Anarchy", "Robo Anarchy", "Cooperative", "Capture the Flag", "Hoard",
// "Team Hoard", "Unknown"};
...
#if DBG
    nLost = (int32_t)(
        (double(networkData.nTotalMissedPackets) /
         double(networkData.nTotalPacketsGot + networkData.nTotalMissedPackets)) *
        100.0);
    if (nLost < 0)
        nLost = 0;
