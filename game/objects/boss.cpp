...
void CBossInfo::InitGateInterval(void) { m_nGateInterval = I2X(4) - gameStates.app.nDifficultyLevel * I2X(2) / 3; }
...
void CBossInfo::ResetCloakTime(void) { m_nCloakStartTime = m_nCloakEndTime = gameData.timeData.xGame; }
...
void CBossData::Destroy(void) { m_info.Destroy(); }
