...
void CBitmap::OglRender(CFloatVector *pColor, int32_t nColors, int32_t orient) {
    float verts[4][2] = {
        {m_render.x0, m_render.y0},
        {m_render.x1, m_render.y0},
        {m_render.x1, m_render.y1},
        {m_render.x0, m_render.y1}};
