...
static void HBoxBlurRGBAWrapped(
    tRGBA *dest,
    tRGBA *src,
    int32_t w,
    int32_t h,
...
static void VBoxBlurRGBAWrapped(
    tRGBA *dest,
    tRGBA *src,
    int32_t w,
    int32_t h,
...
static void HBoxBlurRGBWrapped(
    tRGB *dest,
    tRGB *src,
    int32_t w,
    int32_t h,
...
static void VBoxBlurRGBWrapped(
    tRGB *dest,
    tRGB *src,
    int32_t w,
    int32_t h,
...
static void HBoxBlurRGBAClamped(
    tRGBA *dest,
    tRGBA *src,
    int32_t w,
    int32_t h,
...
static void VBoxBlurRGBAClamped(
    tRGBA *dest,
    tRGBA *src,
    int32_t w,
    int32_t h,
...
static void HBoxBlurRGBClamped(
    tRGB *dest,
    tRGB *src,
    int32_t w,
    int32_t h,
...
static void VBoxBlurRGBClamped(
    tRGB *dest,
    tRGB *src,
    int32_t w,
    int32_t h,
    ...
    if (pBm->m_info.bCartoonizable && gameStates.render.CartoonStyle()) {
		...
		pBuffer = GaussianBlur (ogl.m_data.buffer [1], pBuffer, w, h, tw, m_info.pTexture->TH (), blurRads [0][s], nColors, !gameStates.render.bClampBlur, 1);
            ...
            pBuffer = GaussianBlur(
                ...
                h,
                tw,
                pBm->m_info.pTexture->TH(),
                blurRads[gameStates.render.bBlurTextures][s],
                nColors,
