...
void COGL::SetupOcclusionQuery(void) {
    ...
    PrintLog(
        0,
        m_features.bOcclusionQuery ? (char *)"Occlusion query is available\n"
...
void COGL::SetupTextureArrays(void) {
    ...
    PrintLog(
        0,
        m_features.bTextureArrays ? (char *)"Multi-texturing is available\n"
...
void COGL::SetupMultiTexturing(void) {
    ...
    PrintLog(
        0,
        m_features.bMultiTexturing ? (char *)"Multi-texturing is available\n"
                                   : (char *)"No multi-texturing available\n");
}
